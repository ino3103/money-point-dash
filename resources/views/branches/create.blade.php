                ...
                <div
                    ...
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90 sm:text-2xl">Create
                                    Branch</h2>
                                <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">Add a new branch to the system
                                </p>
                            </div>
                        </div>
