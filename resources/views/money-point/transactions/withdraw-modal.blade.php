            ...
            <form action="{{ route('money-point.transactions.withdraw.store') }}" method="POST">
                ...
                <div class="modal-body p-4">
                    ...
                    @else
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-control ih-medium ip-gray radius-xs b-light px-15 select2"
                                    id="withdraw_provider" name="provider" required>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="withdraw_customer_name" class="form-label fw-bold mb-2">
                                    Customer Name
                                </label>
                                <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                    id="withdraw_customer_name" name="customer_name" placeholder="Enter customer name">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                    id="withdraw_reference" name="reference" placeholder="Enter transaction reference">
                            </div>
                        </div>

                        <div class="row mb-3">
                            <div class="col-md-6" id="withdraw_customer_phone_field">
                            ...
                            <div class="col-md-6" id="withdraw_account_no_field" style="display: none;">
                                <label for="withdraw_account_no" class="form-label fw-bold mb-2">
                                    Account Number <span class="text-danger">*</span>
                                </label>
                                <input type="text" class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                    id="withdraw_account_no" name="account_no" placeholder="Enter account number">
                            </div>
                        </div>
                        ...
                        <script>
                            ...
                            window.toggleWithdrawFields = function() {
                                const providerSelect = document.getElementById('withdraw_provider');
                                const phoneField = document.getElementById('withdraw_customer_phone_field');
                                const accountField = document.getElementById('withdraw_account_no_field');
                                const phoneInput = document.getElementById('withdraw_customer_phone');
                                const accountInput = document.getElementById('withdraw_account_no');
