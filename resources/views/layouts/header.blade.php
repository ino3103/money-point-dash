    ...
    <div class="flex grow flex-col items-center justify-between xl:flex-row xl:px-6">
        <div
            ...
            <a href="{{ route('dashboard') }}" class="xl:hidden">
                ...
                <img class="hidden dark:block" src="{{ asset('assets/images/logo-dark.png') }}" alt="Logo" />
            </a>
            ...
            <div class="2xsm:gap-3 flex items-center gap-2">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" @click.away="open = false" x-transition
                        class="absolute right-0 mt-2 w-32 rounded-lg bg-white shadow-lg dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden z-50">
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                        <img src="{{ asset('assets/images/user/owner.png') }}" alt="User" />
                    </span>
