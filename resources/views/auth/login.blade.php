        ...
        <div>
            ...
            <div class="relative py-3 sm:py-5">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="bg-white p-2 text-gray-400 sm:px-5 sm:py-2 dark:bg-gray-900">{{ __('auth.or') }}</span>
                </div>
            </div>
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" placeholder="{{ __('auth.email') }}"
                    ...
                    <div>
                        ...
                        <div x-data="{ showPassword: false }" class="relative">
                            <input :type="showPassword ? 'text' : 'password'" name="password"
                                placeholder="{{ __('auth.enter_your_password') }}" value="{{ old('password') }}" required
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}"
                                class="text-brand-500 hover:text-brand-600 dark:text-brand-400 text-sm">{{ __('auth.forgot_password') }}</a>
                        @endif
                    </div>
                    <!-- Button -->
                    <div>
            ...
            <div class="mt-5">
                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                    ...
                    <a href="{{ route('register') }}"
                        class="text-brand-500 hover:text-brand-600 dark:text-brand-400">{{ __('auth.sign_up') }}</a>
                </p>
            </div>
        </div>
    </div>
