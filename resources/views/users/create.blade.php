...
@section('title', config('app.name') . ' - ' . __('auth.create_user'))
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90 sm:text-xl">
                                    {{ __('auth.create_user') }}</h2>
                                <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">{{ __('auth.add_new_user') }}
                                </p>
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div x-data="{ switcherToggle: {{ old('is_active', true) ? 'true' : 'false' }} }">
                                        <label for="is_active_toggle_create"
                                            class="flex cursor-pointer items-center gap-3 text-sm font-medium text-gray-700 select-none dark:text-gray-400">
                                            <div class="relative">
                                                <input type="checkbox" name="is_active" value="1"
                                                    id="is_active_toggle_create"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        <input type="password" id="password" name="password" required
                                            class="h-11 w-full rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-800 shadow-sm transition-colors placeholder:text-gray-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-200 dark:placeholder:text-gray-500 dark:focus:border-brand-500 @error('password') border-error-500 focus:border-error-500 focus:ring-error-500/20 @enderror"
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        <input type="password" id="password_confirmation" name="password_confirmation"
                                            required
                                            class="h-11 w-full rounded-lg border border-gray-200 bg-white px-4 py-2.5 text-sm font-medium text-gray-800 shadow-sm transition-colors placeholder:text-gray-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-800 dark:bg-white/[0.03] dark:text-gray-200 dark:placeholder:text-gray-500 dark:focus:border-brand-500 @error('password_confirmation') border-error-500 focus:border-error-500 focus:ring-error-500/20 @enderror"
