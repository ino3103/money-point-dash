...
@section('title', config('app.name') . ' - ' . __('auth.edit_float_type'))
            ...
            <div class="col-span-12">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-xl font-semibold text-gray-800 dark:text-white/90 sm:text-xl">
                                    {{ __('auth.edit_float_type') }}</h2>
                                <p class="mt-0.5 text-sm text-gray-500 dark:text-gray-400">
                                    {{ __('auth.update_float_type_info') }}</p>
                            </div>
                        </div>
                ...
                <div class="mt-4 rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="p-5 sm:p-6">
                        ...
                        <form method="POST" action="{{ route('float-types.update', $floatType) }}" class="space-y-6">
                            @csrf
                            @method('PATCH')
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        <input type="text" id="name" name="name"
                                            value="{{ old('name', $floatType->name) }}" required
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <textarea id="description" name="description" rows="3"
                                        ...
                                        placeholder="Enter description">{{ old('description', $floatType->description) }}</textarea>
                                </div>
                                @error('description')
                                    <p class="mt-1 flex items-center gap-1.5 text-sm text-error-600 dark:text-error-400">
                                        <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <!-- Active Status -->
                            <div x-data="{ switcherToggle: {{ old('is_active', $floatType->is_active) ? 'true' : 'false' }} }">
                                <label for="is_active"
                                    class="flex cursor-pointer items-center gap-3 text-sm font-medium text-gray-700 select-none dark:text-gray-400">
                                    <div class="relative">
                                        <input type="checkbox" name="is_active" value="1" id="is_active"
                                            {{ old('is_active', $floatType->is_active) ? 'checked' : '' }} class="sr-only"
